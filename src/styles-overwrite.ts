...
export const navTheme: CustomFlowbiteTheme['navbar'] = {
    "root": {
    ...
    "link": {
        ...
        "active": {
            "on": "bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 text-white dark:text-white md:bg-transparent md:bg-none md:text-blue-500",
